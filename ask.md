...
// /** @NApiVersion 2.1 */
// const customrecordcust_movie_recordSearchObj = search.create({
//    type: "customrecordcust_movie_record",
//    filters:
//    [
//    ],
//    columns:
//    [
//       search.createColumn({name: "custrecordcust_movie_name", label: "Movie Name"}),
//       search.createColumn({name: "custrecordcust_rating_by_users_no", label: "Rating By users"}),
//       search.createColumn({name: "custrecordcust_movie_rating", label: "Rating"})
//    ]
// });
// const searchResultCount = customrecordcust_movie_recordSearchObj.runPaged().count;
// log.debug("customrecordcust_movie_recordSearchObj result count",searchResultCount);
// customrecordcust_movie_recordSearchObj.run().each(function(result){
//    // .run().each has a limit of 4,000 results
//    return true;
// });

// /*
// customrecordcust_movie_recordSearchObj.id="customsearch1782471674157";
// customrecordcust_movie_recordSearchObj.title="Movie rating Search (copy)";
// const newSearchId = customrecordcust_movie_recordSearchObj.save();
// */